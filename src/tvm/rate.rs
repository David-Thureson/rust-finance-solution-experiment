...
fn check_symmetry_test_numbers() {
    let r = 0.1;
    let n = 4;
    let pv = -5_000;
    let continuous = true;
    let fv = finance_solution::future_value(r, n, pv, continuous);
    println!("r = {}, n = {}, pv = {}, fv = {}, continuous = {}", r, n, pv, fv, continuous);

    let r_calc = finance_solution::rate(n, pv, fv, continuous);
    dbg!(r_calc);
}
