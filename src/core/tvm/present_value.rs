...
\begin{axis}[axis line style=gray,
	...
	axis y line=center,
	xlabel=$n$,ylabel=$pv$]
\addplot[blue,domain=1:12,semithick, only marks]{100/((1+(0.2/x))^x)};
\addplot[black,domain=1:12, thick]{100/(e^(0.2))};
\addplot[] coordinates {(2.3,81.53)} node{$pv={100 \over e^{0.2}}$};
\addplot[blue] coordinates {(4.5,82.8)} node{$pv={100 \over (1+{0.2 \over n})^n}$};
\path (axis cs:0,83) node [anchor=north west,yshift=-0.07cm];
\end{axis}
\end{tikzpicture}$$
